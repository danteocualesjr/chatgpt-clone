    ...
    <div className="flex flex-col h-full relative bg-gradient-to-b from-background via-background to-muted/20">
      ...
      {error && (
        <div className="absolute bottom-28 left-1/2 -translate-x-1/2 z-20 animate-fade-in">
          <div className="bg-red-50 dark:bg-red-950/50 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 px-5 py-3 rounded-2xl text-sm shadow-xl backdrop-blur-sm max-w-md mx-4">
            {error}
          </div>
        </div>
      )}
